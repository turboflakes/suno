...
- Add Chain-specs and Metadata QR codes to update Polkadot Vault see PR [#32](https://github.com/turboflakes/suno/pull/32)
- Add timeouts on subscriptions to ease reconnection
